				...
				<div class="details-banner">
					...
					<div class="details-banner--info">
						<a href="#" class="details-banner--info--box">
							<img id="Img2"
								 runat="server"
								 class="details-banner--info--box--img"
								 src="<%# img2Src %>"
								 srcset="<%# img2Src,img2Src %> 2x"
								 alt="alt">
						</a>
						<h1 class="details-banner--info--name"><a class="details-banner--info--name--link" href="#"><%#bannerTitle%></a></h1>
					</div>
				</div>
				...
				<div class="discovery--container u-container">
					<main class="discovery--section">
						<section class="standard--holder">
							...
							<ul runat="server" id="itemsTopSongs" class="song-list mod-new mod-menu">
									...
									<ItemTemplate>
										<li class="song-list--item media-player--row">
											...
											<div class="song-list--item--right">
												...
												<a class="song-list--item--secondary"><%#Eval("bpmConverted")%> BPM</a>
												<a class="song-list--item--secondary"><%#Eval("timeSignatureString")%></a>
								...
								<section class="standard--holder">
									...
									<div class="discovery--grid-holder">
										...
										<div class="ly-grid ly-grid-cranberries">
												<asp:Repeater ID="albumsItems" runat="server">
													<ItemTemplate>
